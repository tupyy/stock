...
type ClientService interface {
	...
	GetCompanies(params *GetCompaniesParams) (*GetCompaniesOK, error)

	GetStock(params *GetStockParams) (*GetStockOK, error)

	GetStocksCompany(params *GetStocksCompanyParams) (*GetStocksCompanyOK, error)
...
/*
  GetCompanies lists all followed companies
*/
func (a *Client) GetCompanies(params *GetCompaniesParams) (*GetCompaniesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
/*
  GetStocksCompany gets daily stock values for a company
*/
func (a *Client) GetStocksCompany(params *GetStocksCompanyParams) (*GetStocksCompanyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetStocksCompanyParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "GetStocksCompany",
		Method:             "GET",
		PathPattern:        "/stocks/{company}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetStocksCompanyReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*GetStocksCompanyOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetStocksCompany: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
